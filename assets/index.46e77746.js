const Pe=function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))a(r);new MutationObserver(r=>{for(const i of r)if(i.type==="childList")for(const p of i.addedNodes)p.tagName==="LINK"&&p.rel==="modulepreload"&&a(p)}).observe(document,{childList:!0,subtree:!0});function s(r){const i={};return r.integrity&&(i.integrity=r.integrity),r.referrerpolicy&&(i.referrerPolicy=r.referrerpolicy),r.crossorigin==="use-credentials"?i.credentials="include":r.crossorigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function a(r){if(r.ep)return;r.ep=!0;const i=s(r);fetch(r.href,i)}};Pe();function w(){}function Te(t){return t()}function _e(){return Object.create(null)}function D(t){t.forEach(Te)}function Ee(t){return typeof t=="function"}function N(t,e){return t!=t?e==e:t!==e||t&&typeof t=="object"||typeof t=="function"}let ee;function Je(t,e){return ee||(ee=document.createElement("a")),ee.href=e,t===ee.href}function Me(t){return Object.keys(t).length===0}function n(t,e){t.appendChild(e)}function H(t,e,s){t.insertBefore(e,s||null)}function A(t){t.parentNode.removeChild(t)}function m(t){return document.createElement(t)}function M(t){return document.createTextNode(t)}function j(){return M(" ")}function R(t,e,s,a){return t.addEventListener(e,s,a),()=>t.removeEventListener(e,s,a)}function o(t,e,s){s==null?t.removeAttribute(e):t.getAttribute(e)!==s&&t.setAttribute(e,s)}function Re(t){return Array.from(t.childNodes)}function F(t,e,s,a){s===null?t.style.removeProperty(e):t.style.setProperty(e,s,a?"important":"")}let me;function Z(t){me=t}const B=[],Ie=[],se=[],je=[],De=Promise.resolve();let he=!1;function Ne(){he||(he=!0,De.then(Ae))}function re(t){se.push(t)}const ue=new Set;let te=0;function Ae(){const t=me;do{for(;te<B.length;){const e=B[te];te++,Z(e),He(e.$$)}for(Z(null),B.length=0,te=0;Ie.length;)Ie.pop()();for(let e=0;e<se.length;e+=1){const s=se[e];ue.has(s)||(ue.add(s),s())}se.length=0}while(B.length);for(;je.length;)je.pop()();he=!1,ue.clear(),Z(t)}function He(t){if(t.fragment!==null){t.update(),D(t.before_update);const e=t.dirty;t.dirty=[-1],t.fragment&&t.fragment.p(t.ctx,e),t.after_update.forEach(re)}}const ae=new Set;let T;function K(){T={r:0,c:[],p:T}}function U(){T.r||D(T.c),T=T.p}function d(t,e){t&&t.i&&(ae.delete(t),t.i(e))}function k(t,e,s,a){if(t&&t.o){if(ae.has(t))return;ae.add(t),T.c.push(()=>{ae.delete(t),a&&(s&&t.d(1),a())}),t.o(e)}}function Q(t){t&&t.c()}function O(t,e,s,a){const{fragment:r,on_mount:i,on_destroy:p,after_update:u}=t.$$;r&&r.m(e,s),a||re(()=>{const c=i.map(Te).filter(Ee);p?p.push(...c):D(c),t.$$.on_mount=[]}),u.forEach(re)}function q(t,e){const s=t.$$;s.fragment!==null&&(D(s.on_destroy),s.fragment&&s.fragment.d(e),s.on_destroy=s.fragment=null,s.ctx=[])}function Oe(t,e){t.$$.dirty[0]===-1&&(B.push(t),Ne(),t.$$.dirty.fill(0)),t.$$.dirty[e/31|0]|=1<<e%31}function W(t,e,s,a,r,i,p,u=[-1]){const c=me;Z(t);const l=t.$$={fragment:null,ctx:null,props:i,update:w,not_equal:r,bound:_e(),on_mount:[],on_destroy:[],on_disconnect:[],before_update:[],after_update:[],context:new Map(e.context||(c?c.$$.context:[])),callbacks:_e(),dirty:u,skip_bound:!1,root:e.target||c.$$.root};p&&p(l.root);let L=!1;if(l.ctx=s?s(t,e.props||{},(I,$,...G)=>{const C=G.length?G[0]:$;return l.ctx&&r(l.ctx[I],l.ctx[I]=C)&&(!l.skip_bound&&l.bound[I]&&l.bound[I](C),L&&Oe(t,I)),$}):[],l.update(),L=!0,D(l.before_update),l.fragment=a?a(l.ctx):!1,e.target){if(e.hydrate){const I=Re(e.target);l.fragment&&l.fragment.l(I),I.forEach(A)}else l.fragment&&l.fragment.c();e.intro&&d(t.$$.fragment),O(t,e.target,e.anchor,e.customElement),Ae()}Z(c)}class z{$destroy(){q(this,1),this.$destroy=w}$on(e,s){const a=this.$$.callbacks[e]||(this.$$.callbacks[e]=[]);return a.push(s),()=>{const r=a.indexOf(s);r!==-1&&a.splice(r,1)}}$set(e){this.$$set&&!Me(e)&&(this.$$.skip_bound=!0,this.$$set(e),this.$$.skip_bound=!1)}}function qe(t){let e;return{c(){e=m("div"),e.innerHTML=`<div class="hero-content text-center text-neutral-content"><div class="max-w-md shadow-xl mockup-code text-left"><pre data-prefix="$"><code>whoami</code></pre> 
  ...
  <div class="flex flex-col lg:mt-16"><div class="lg:absolute bottom-16 right-12"><a href="https://github.com/cademichael" target="_blank"><i class="fa fa-github fa-3x m-2 "></i></a> 
      <a href="https://www.linkedin.com/in/cade-lueker-79a55b199/" target="_blank"><i class="fa fa-linkedin fa-3x m-2"></i></a></div></div>`},m(s,a){H(s,e,a)},p:w,i:w,o:w,d(s){s&&A(e)}}}class We extends z{constructor(e){super(),W(this,e,null,qe,N,{})}}function ze(t){let e;return{c(){e=m("div"),e.innerHTML=`<div class="flex flex-col overflow-scroll h-full"><div class="flex flex-col"><h1 class="text-3xl mx-6 -mb-6 mt-4"><span class="text-secondary">#</span> About Me</h1> 
      ...
      <div class="card bg-base-100 mt-4 mx-6 shadow-xl lg:card-side"><div class="card-body"><h2 class="card-title"><span class="text-2xl"><span class="text-secondary">##</span>
              Project management tool</span></h2> 
          <div class="text-xl"><h3 class="mb-3"><span class="text-info">Language / Framework: </span>Rust &amp; Cursive</h3> 
            <h3><span class="text-info">Function:</span>
            After migrating my development environment from Emacs to Neovim I found myself 
            missing the package projectile and the ease with which I could enter and or switch 
            between projects. At the same time I was beginning to start learning rust more seriously and 
            decided to dogfood a small TUI that would replace the main functionality I missed from projectile
            and used rust with the cursive TUI framework to accomplish that goal. Overall I am very happy with how usefull
            the project is and it is currently sitting at 10 github stars.</h3></div> 
          <div class="card-actions justify-end"><a href="https://github.com/cademichael/rject" target="_blank" class="btn btn-info">repo</a></div></div> 
        <figure class="rounded-lg m-2"><img class="rounded-lg border border-rounded border-info min-w-[20em]" src="images/rject.png" alt="Rject"/></figure></div> 
      ...
      <div class="card bg-base-100 mt-4 mx-6 shadow-xl lg:card-side"><div class="card-body"><h2 class="card-title"><span class="text-2xl"><span class="text-secondary">##</span>
        ...
        <figure class="rounded-lg m-2"><img class="rounded-lg border border-rounded border-info min-w-[20em]" src="images/flask.jpg" alt="flask"/></figure></div></div></div>`,o(e,"class","m-4 mockup-window border border-secondary bg-base-100 shadow-lg"),F(e,"height","95%"),F(e,"width","90%")},m(s,a){H(s,e,a)},p:w,i:w,o:w,d(s){s&&A(e)}}}class Ue extends z{constructor(e){super(),W(this,e,null,Ke,N,{})}}function Be(t){let e;return{c(){e=m("div"),e.innerHTML=`<div class="flex flex-col overflow-scroll h-full"><div class="flex flex-col mb-16"><div class="text-3xl mx-6 mt-4"><span class="text-secondary">#</span>  
...
The JS Dev I certification tests your ability to work with vanilla JavaScript with respect to the browser, dom, and NodeJs (Server Side) in addition comprehensive knowledge of Salesforce Lightning Web Components. It is comprised of an exam hosted by <b>Webassessor</b> which tests JavaScript knowledge and a Salesforce trailhead &quot;<span class="text-secondary"><a href="https://trailhead.salesforce.com/content/learn/superbadges/superbadge_lwc_specialist"><u>superbadge</u></a></span>&quot; in Lightning web components. Once the exam is passed and the project based &quot;superbadge&quot; has been approved you receive the certification.</h3></div> 
        ...
        <figure class="rounded-lg m-2"><img class="rounded-lg border border-rounded border-info p-2 w-[20em]" src="images/js_d_I.png" alt="cert"/></figure></div></div></div>`,o(e,"class","m-4 mockup-window border border-secondary bg-base-100 shadow-lg"),F(e,"height","95%"),F(e,"width","90%")},m(s,a){H(s,e,a)},p:w,i:w,o:w,d(s){s&&A(e)}}}class Ze extends z{constructor(e){super(),W(this,e,null,Be,N,{})}}function Qe(t){let e,s,a,r,i,p,u;return re(t[1]),{c(){e=m("div"),s=m("div"),a=m("iframe"),o(a,"class","overflow-scroll"),o(a,"title","Resume"),Je(a.src,r="images/Resume.pdf")||o(a,"src",r),o(a,"width","100%"),o(a,"height",i=t[0]*.85+"px"),o(s,"class","flex flex-col items-center shadow-xl m-8"),o(e,"class","mockup-window border border-secondary bg-base-100 shadow-lg"),F(e,"height","95%"),F(e,"width","90%")},m(c,l){H(c,e,l),n(e,s),n(s,a),p||(u=R(window,"resize",t[1]),p=!0)},p(c,[l]){l&1&&i!==(i=c[0]*.85+"px")&&o(a,"height",i)},i:w,o:w,d(c){c&&A(e),p=!1,u()}}}function Ve(t,e,s){let a;function r(){s(0,a=window.innerHeight)}return[a,r]}class Ye extends z{constructor(e){super(),W(this,e,Ve,Qe,N,{})}}function $e(t){let e,s;return e=new We({}),{c(){Q(e.$$.fragment)},m(a,r){O(e,a,r),s=!0},i(a){s||(d(e.$$.fragment,a),s=!0)},o(a){k(e.$$.fragment,a),s=!1},d(a){q(e,a)}}}function Se(t){let e,s;return e=new Ge({}),{c(){Q(e.$$.fragment)},m(a,r){O(e,a,r),s=!0},i(a){s||(d(e.$$.fragment,a),s=!0)},o(a){k(e.$$.fragment,a),s=!1},d(a){q(e,a)}}}function Fe(t){let e,s;return e=new Ue({}),{c(){Q(e.$$.fragment)},m(a,r){O(e,a,r),s=!0},i(a){s||(d(e.$$.fragment,a),s=!0)},o(a){k(e.$$.fragment,a),s=!1},d(a){q(e,a)}}}function Le(t){let e,s;return e=new Ze({}),{c(){Q(e.$$.fragment)},m(a,r){O(e,a,r),s=!0},i(a){s||(d(e.$$.fragment,a),s=!0)},o(a){k(e.$$.fragment,a),s=!1},d(a){q(e,a)}}}function Ce(t){let e,s;return e=new Ye({}),{c(){Q(e.$$.fragment)},m(a,r){O(e,a,r),s=!0},i(a){s||(d(e.$$.fragment,a),s=!0)},o(a){k(e.$$.fragment,a),s=!1},d(a){q(e,a)}}}function Xe(t){let e,s,a,r,i,p,u,c,l,L,I,$,G,C,pe,P,fe,V,ge,E,be,Y,xe,J,ve,X,ye,h,ne,we,oe,ie,le,ce,S,de,ke,f=t[0]==="home"&&$e(),g=t[0]==="about"&&Se(),b=t[0]==="projects"&&Fe(),x=t[0]==="certs"&&Le(),v=t[0]==="resume"&&Ce();return{c(){e=m("main"),s=m("div"),a=m("div"),r=m("div"),i=m("div"),i.innerHTML='<div class="w-44 mask mask-hexagon"><img src="images/profile.jpg" alt=""/></div>',p=j(),u=m("ul"),c=m("button"),l=M("Home"),I=j(),$=m("button"),G=M("About"),pe=j(),P=m("button"),fe=M("Projects"),ge=j(),E=m("button"),be=M("Certifications"),xe=j(),J=m("button"),ve=M("Resume"),ye=j(),h=m("div"),ne=m("div"),we=j(),f&&f.c(),oe=j(),g&&g.c(),ie=j(),b&&b.c(),le=j(),x&&x.c(),ce=j(),v&&v.c(),o(i,"class","avatar m-4"),o(c,"class",L=t[0]==="home"?"step step-secondary text-secondary font-bold text-xl":"step"),o($,"class",C=t[0]==="about"?"step step-secondary text-secondary font-bold text-xl":"step"),o(P,"class",V=t[0]==="projects"?"step step-secondary text-secondary font-bold text-xl":"step"),o(E,"class",Y=t[0]==="certs"?"step step-secondary text-secondary font-bold text-xl":"step"),o(J,"class",X=t[0]==="resume"?"step step-secondary text-secondary font-bold text-xl":"step"),o(u,"class","steps steps-vertical"),o(r,"class","flex flex-col"),o(a,"class","m-8 grid flex-grow"),o(ne,"class","hero-overlay bg-opacity-40"),o(h,"class","hero grid flex-grow min-h-screen lg:h-screen"),F(h,"background-image","url(images/background.jpg)"),o(s,"class","flex flex-col w-full lg:flex-row")},m(y,_){H(y,e,_),n(e,s),n(s,a),n(a,r),n(r,i),n(r,p),n(r,u),n(u,c),n(c,l),n(u,I),n(u,$),n($,G),n(u,pe),n(u,P),n(P,fe),n(u,ge),n(u,E),n(E,be),n(u,xe),n(u,J),n(J,ve),n(s,ye),n(s,h),n(h,ne),n(h,we),f&&f.m(h,null),n(h,oe),g&&g.m(h,null),n(h,ie),b&&b.m(h,null),n(h,le),x&&x.m(h,null),n(h,ce),v&&v.m(h,null),S=!0,de||(ke=[R(c,"click",t[1]),R($,"click",t[2]),R(P,"click",t[3]),R(E,"click",t[4]),R(J,"click",t[5])],de=!0)},p(y,[_]){(!S||_&1&&L!==(L=y[0]==="home"?"step step-secondary text-secondary font-bold text-xl":"step"))&&o(c,"class",L),(!S||_&1&&C!==(C=y[0]==="about"?"step step-secondary text-secondary font-bold text-xl":"step"))&&o($,"class",C),(!S||_&1&&V!==(V=y[0]==="projects"?"step step-secondary text-secondary font-bold text-xl":"step"))&&o(P,"class",V),(!S||_&1&&Y!==(Y=y[0]==="certs"?"step step-secondary text-secondary font-bold text-xl":"step"))&&o(E,"class",Y),(!S||_&1&&X!==(X=y[0]==="resume"?"step step-secondary text-secondary font-bold text-xl":"step"))&&o(J,"class",X),y[0]==="home"?f?_&1&&d(f,1):(f=$e(),f.c(),d(f,1),f.m(h,oe)):f&&(K(),k(f,1,1,()=>{f=null}),U()),y[0]==="about"?g?_&1&&d(g,1):(g=Se(),g.c(),d(g,1),g.m(h,ie)):g&&(K(),k(g,1,1,()=>{g=null}),U()),y[0]==="projects"?b?_&1&&d(b,1):(b=Fe(),b.c(),d(b,1),b.m(h,le)):b&&(K(),k(b,1,1,()=>{b=null}),U()),y[0]==="certs"?x?_&1&&d(x,1):(x=Le(),x.c(),d(x,1),x.m(h,ce)):x&&(K(),k(x,1,1,()=>{x=null}),U()),y[0]==="resume"?v?_&1&&d(v,1):(v=Ce(),v.c(),d(v,1),v.m(h,null)):v&&(K(),k(v,1,1,()=>{v=null}),U())},i(y){S||(d(f),d(g),d(b),d(x),d(v),S=!0)},o(y){k(f),k(g),k(b),k(x),k(v),S=!1},d(y){y&&A(e),f&&f.d(),g&&g.d(),b&&b.d(),x&&x.d(),v&&v.d(),de=!1,D(ke)}}}function et(t,e,s){let a="home";return[a,()=>s(0,a="home"),()=>s(0,a="about"),()=>s(0,a="projects"),()=>s(0,a="certs"),()=>s(0,a="resume")]}class tt extends z{constructor(e){super(),W(this,e,et,Xe,N,{})}}new tt({target:document.getElementById("app")});
