const Ae=function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))a(r);new MutationObserver(r=>{for(const i of r)if(i.type==="childList")for(const m of i.addedNodes)m.tagName==="LINK"&&m.rel==="modulepreload"&&a(m)}).observe(document,{childList:!0,subtree:!0});function s(r){const i={};return r.integrity&&(i.integrity=r.integrity),r.referrerpolicy&&(i.referrerPolicy=r.referrerpolicy),r.crossorigin==="use-credentials"?i.credentials="include":r.crossorigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function a(r){if(r.ep)return;r.ep=!0;const i=s(r);fetch(r.href,i)}};Ae();function w(){}function Te(t){return t()}function _e(){return Object.create(null)}function H(t){t.forEach(Te)}function Ee(t){return typeof t=="function"}function O(t,e){return t!=t?e==e:t!==e||t&&typeof t=="object"||typeof t=="function"}let ee;function Je(t,e){return ee||(ee=document.createElement("a")),ee.href=e,t===ee.href}function Me(t){return Object.keys(t).length===0}function n(t,e){t.appendChild(e)}function R(t,e,s){t.insertBefore(e,s||null)}function P(t){t.parentNode.removeChild(t)}function p(t){return document.createElement(t)}function M(t){return document.createTextNode(t)}function j(){return M(" ")}function D(t,e,s,a){return t.addEventListener(e,s,a),()=>t.removeEventListener(e,s,a)}function o(t,e,s){s==null?t.removeAttribute(e):t.getAttribute(e)!==s&&t.setAttribute(e,s)}function De(t){return Array.from(t.childNodes)}function L(t,e,s,a){s===null?t.style.removeProperty(e):t.style.setProperty(e,s,a?"important":"")}let pe;function Q(t){pe=t}const B=[],Ie=[],se=[],je=[],He=Promise.resolve();let he=!1;function Oe(){he||(he=!0,He.then(Pe))}function re(t){se.push(t)}const ue=new Set;let te=0;function Pe(){const t=pe;do{for(;te<B.length;){const e=B[te];te++,Q(e),Re(e.$$)}for(Q(null),B.length=0,te=0;Ie.length;)Ie.pop()();for(let e=0;e<se.length;e+=1){const s=se[e];ue.has(s)||(ue.add(s),s())}se.length=0}while(B.length);for(;je.length;)je.pop()();he=!1,ue.clear(),Q(t)}function Re(t){if(t.fragment!==null){t.update(),H(t.before_update);const e=t.dirty;t.dirty=[-1],t.fragment&&t.fragment.p(t.ctx,e),t.after_update.forEach(re)}}const ae=new Set;let T;function z(){T={r:0,c:[],p:T}}function U(){T.r||H(T.c),T=T.p}function d(t,e){t&&t.i&&(ae.delete(t),t.i(e))}function k(t,e,s,a){if(t&&t.o){if(ae.has(t))return;ae.add(t),T.c.push(()=>{ae.delete(t),a&&(s&&t.d(1),a())}),t.o(e)}}function V(t){t&&t.c()}function q(t,e,s,a){const{fragment:r,on_mount:i,on_destroy:m,after_update:u}=t.$$;r&&r.m(e,s),a||re(()=>{const c=i.map(Te).filter(Ee);m?m.push(...c):H(c),t.$$.on_mount=[]}),u.forEach(re)}function N(t,e){const s=t.$$;s.fragment!==null&&(H(s.on_destroy),s.fragment&&s.fragment.d(e),s.on_destroy=s.fragment=null,s.ctx=[])}function qe(t,e){t.$$.dirty[0]===-1&&(B.push(t),Oe(),t.$$.dirty.fill(0)),t.$$.dirty[e/31|0]|=1<<e%31}function W(t,e,s,a,r,i,m,u=[-1]){const c=pe;Q(t);const l=t.$$={fragment:null,ctx:null,props:i,update:w,not_equal:r,bound:_e(),on_mount:[],on_destroy:[],on_disconnect:[],before_update:[],after_update:[],context:new Map(e.context||(c?c.$$.context:[])),callbacks:_e(),dirty:u,skip_bound:!1,root:e.target||c.$$.root};m&&m(l.root);let C=!1;if(l.ctx=s?s(t,e.props||{},(I,$,...K)=>{const F=K.length?K[0]:$;return l.ctx&&r(l.ctx[I],l.ctx[I]=F)&&(!l.skip_bound&&l.bound[I]&&l.bound[I](F),C&&qe(t,I)),$}):[],l.update(),C=!0,H(l.before_update),l.fragment=a?a(l.ctx):!1,e.target){if(e.hydrate){const I=De(e.target);l.fragment&&l.fragment.l(I),I.forEach(P)}else l.fragment&&l.fragment.c();e.intro&&d(t.$$.fragment),q(t,e.target,e.anchor,e.customElement),Pe()}Q(c)}class G{$destroy(){N(this,1),this.$destroy=w}$on(e,s){const a=this.$$.callbacks[e]||(this.$$.callbacks[e]=[]);return a.push(s),()=>{const r=a.indexOf(s);r!==-1&&a.splice(r,1)}}$set(e){this.$$set&&!Me(e)&&(this.$$.skip_bound=!0,this.$$set(e),this.$$.skip_bound=!1)}}function Ne(t){let e;return{c(){e=p("div"),e.innerHTML=`<div class="hero-content text-center text-neutral-content"><div class="max-w-md shadow-xl mockup-code text-left"><pre data-prefix="$"><code>whoami</code></pre> 
...
The JS Dev I certification tests your ability to work with vanilla JavaScript with respect to the browser, dom, and NodeJs (Server Side) in addition comprehensive knowledge of Salesforce Lightning Web Components. It is comprised of an exam hosted by <b>Webassessor</b> which tests JavaScript knowledge and a Salesforce trailhead &quot;<span class="text-secondary"><a href="https://trailhead.salesforce.com/content/learn/superbadges/superbadge_lwc_specialist"><u>superbadge</u></a></span>&quot; in Lightning web components. Once the exam is passed and the project based &quot;superbadge&quot; has been approved you receive the certification.</h3></div> 
        ...
        <figure class="rounded-lg m-2"><img class="rounded-lg border border-rounded border-info p-2 w-[20em]" src="images/js_d_I.png" alt="cert"/></figure></div></div></div>`,o(e,"class","m-4 mockup-window border border-secondary bg-base-100 shadow-lg"),L(e,"height","95%"),L(e,"width","90%")},m(s,a){R(s,e,a)},p:w,i:w,o:w,d(s){s&&P(e)}}}class Qe extends G{constructor(e){super(),W(this,e,null,Be,O,{})}}function Ve(t){let e,s,a,r,i,m,u;return re(t[1]),{c(){e=p("div"),s=p("div"),a=p("iframe"),o(a,"class","overflow-scroll"),o(a,"title","Resume"),Je(a.src,r="images/resume.pdf")||o(a,"src",r),o(a,"width","100%"),o(a,"height",i=t[0]*.85+"px"),o(s,"class","flex flex-col items-center shadow-xl m-8"),o(e,"class","mockup-window border border-secondary bg-base-100 shadow-lg"),L(e,"height","95%"),L(e,"width","90%")},m(c,l){R(c,e,l),n(e,s),n(s,a),m||(u=D(window,"resize",t[1]),m=!0)},p(c,[l]){l&1&&i!==(i=c[0]*.85+"px")&&o(a,"height",i)},i:w,o:w,d(c){c&&P(e),m=!1,u()}}}function Ye(t,e,s){let a;function r(){s(0,a=window.innerHeight)}return[a,r]}class Xe extends G{constructor(e){super(),W(this,e,Ye,Ve,O,{})}}function $e(t){let e,s;return e=new We({}),{c(){V(e.$$.fragment)},m(a,r){q(e,a,r),s=!0},i(a){s||(d(e.$$.fragment,a),s=!0)},o(a){k(e.$$.fragment,a),s=!1},d(a){N(e,a)}}}function Se(t){let e,s;return e=new Ke({}),{c(){V(e.$$.fragment)},m(a,r){q(e,a,r),s=!0},i(a){s||(d(e.$$.fragment,a),s=!0)},o(a){k(e.$$.fragment,a),s=!1},d(a){N(e,a)}}}function Le(t){let e,s;return e=new Ue({}),{c(){V(e.$$.fragment)},m(a,r){q(e,a,r),s=!0},i(a){s||(d(e.$$.fragment,a),s=!0)},o(a){k(e.$$.fragment,a),s=!1},d(a){N(e,a)}}}function Ce(t){let e,s;return e=new Qe({}),{c(){V(e.$$.fragment)},m(a,r){q(e,a,r),s=!0},i(a){s||(d(e.$$.fragment,a),s=!0)},o(a){k(e.$$.fragment,a),s=!1},d(a){N(e,a)}}}function Fe(t){let e,s;return e=new Xe({}),{c(){V(e.$$.fragment)},m(a,r){q(e,a,r),s=!0},i(a){s||(d(e.$$.fragment,a),s=!0)},o(a){k(e.$$.fragment,a),s=!1},d(a){N(e,a)}}}function Ze(t){let e,s,a,r,i,m,u,c,l,C,I,$,K,F,me,A,fe,Y,ge,E,be,X,xe,J,ve,Z,ye,h,ne,we,oe,ie,le,ce,S,de,ke,f=t[0]==="home"&&$e(),g=t[0]==="about"&&Se(),b=t[0]==="projects"&&Le(),x=t[0]==="certs"&&Ce(),v=t[0]==="resume"&&Fe();return{c(){e=p("main"),s=p("div"),a=p("div"),r=p("div"),i=p("div"),i.innerHTML='<div class="w-44 mask mask-hexagon"><img src="images/profile.jpg" alt=""/></div>',m=j(),u=p("ul"),c=p("button"),l=M("Home"),I=j(),$=p("button"),K=M("About"),me=j(),A=p("button"),fe=M("Projects"),ge=j(),E=p("button"),be=M("Certifications"),xe=j(),J=p("button"),ve=M("Resume"),ye=j(),h=p("div"),ne=p("div"),we=j(),f&&f.c(),oe=j(),g&&g.c(),ie=j(),b&&b.c(),le=j(),x&&x.c(),ce=j(),v&&v.c(),o(i,"class","avatar m-4"),o(c,"class",C=t[0]==="home"?"step step-secondary text-secondary font-bold text-xl":"step"),o($,"class",F=t[0]==="about"?"step step-secondary text-secondary font-bold text-xl":"step"),o(A,"class",Y=t[0]==="projects"?"step step-secondary text-secondary font-bold text-xl":"step"),o(E,"class",X=t[0]==="certs"?"step step-secondary text-secondary font-bold text-xl":"step"),o(J,"class",Z=t[0]==="resume"?"step step-secondary text-secondary font-bold text-xl":"step"),o(u,"class","steps steps-vertical"),o(r,"class","flex flex-col"),o(a,"class","m-8 grid flex-grow"),o(ne,"class","hero-overlay bg-opacity-40"),o(h,"class","hero grid flex-grow min-h-screen lg:h-screen"),L(h,"background-image","url(images/background.jpg)"),o(s,"class","flex flex-col w-full lg:flex-row")},m(y,_){R(y,e,_),n(e,s),n(s,a),n(a,r),n(r,i),n(r,m),n(r,u),n(u,c),n(c,l),n(u,I),n(u,$),n($,K),n(u,me),n(u,A),n(A,fe),n(u,ge),n(u,E),n(E,be),n(u,xe),n(u,J),n(J,ve),n(s,ye),n(s,h),n(h,ne),n(h,we),f&&f.m(h,null),n(h,oe),g&&g.m(h,null),n(h,ie),b&&b.m(h,null),n(h,le),x&&x.m(h,null),n(h,ce),v&&v.m(h,null),S=!0,de||(ke=[D(c,"click",t[1]),D($,"click",t[2]),D(A,"click",t[3]),D(E,"click",t[4]),D(J,"click",t[5])],de=!0)},p(y,[_]){(!S||_&1&&C!==(C=y[0]==="home"?"step step-secondary text-secondary font-bold text-xl":"step"))&&o(c,"class",C),(!S||_&1&&F!==(F=y[0]==="about"?"step step-secondary text-secondary font-bold text-xl":"step"))&&o($,"class",F),(!S||_&1&&Y!==(Y=y[0]==="projects"?"step step-secondary text-secondary font-bold text-xl":"step"))&&o(A,"class",Y),(!S||_&1&&X!==(X=y[0]==="certs"?"step step-secondary text-secondary font-bold text-xl":"step"))&&o(E,"class",X),(!S||_&1&&Z!==(Z=y[0]==="resume"?"step step-secondary text-secondary font-bold text-xl":"step"))&&o(J,"class",Z),y[0]==="home"?f?_&1&&d(f,1):(f=$e(),f.c(),d(f,1),f.m(h,oe)):f&&(z(),k(f,1,1,()=>{f=null}),U()),y[0]==="about"?g?_&1&&d(g,1):(g=Se(),g.c(),d(g,1),g.m(h,ie)):g&&(z(),k(g,1,1,()=>{g=null}),U()),y[0]==="projects"?b?_&1&&d(b,1):(b=Le(),b.c(),d(b,1),b.m(h,le)):b&&(z(),k(b,1,1,()=>{b=null}),U()),y[0]==="certs"?x?_&1&&d(x,1):(x=Ce(),x.c(),d(x,1),x.m(h,ce)):x&&(z(),k(x,1,1,()=>{x=null}),U()),y[0]==="resume"?v?_&1&&d(v,1):(v=Fe(),v.c(),d(v,1),v.m(h,null)):v&&(z(),k(v,1,1,()=>{v=null}),U())},i(y){S||(d(f),d(g),d(b),d(x),d(v),S=!0)},o(y){k(f),k(g),k(b),k(x),k(v),S=!1},d(y){y&&P(e),f&&f.d(),g&&g.d(),b&&b.d(),x&&x.d(),v&&v.d(),de=!1,H(ke)}}}function et(t,e,s){let a="home";return[a,()=>s(0,a="home"),()=>s(0,a="about"),()=>s(0,a="projects"),()=>s(0,a="certs"),()=>s(0,a="resume")]}class tt extends G{constructor(e){super(),W(this,e,et,Ze,O,{})}}new tt({target:document.getElementById("app")});
